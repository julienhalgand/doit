...
<p>Conditions générales d'utilisation du site doit.mywebideas.net</p>
<p>
ARTICLE 1 : Objet
Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site DOIT et leur utilisation par « l'Utilisateur ».
...
<ul>
  ...
  <li>• DOIT se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</li>
</ul>
</p>
<p>
ARTICLE 2 : Mentions légales
L'édition du site DOIT est assurée par des particuliers qui souhaitent restés anonymes.
Le Directeur de la publication est Monsieur Halgand Julien.
L'hébergeur du site DOIT est la Société OVH SAS au capital de 10 069 020 €
...
<ul>
  ...
  <li>•	Création, édition, suppression de listes de tâches</li>
  <li>•	Invitation de collaborateur sur une liste</li>
</ul>
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de DOIT.
...
L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse julien.halgand1@gmail.com
</p>
<p>
...
<ul>
  <li>•	par mail à julien.halgand1@gmail.com</li>
</ul>
</p>
<p>
...
De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de doit.mywebideas.net qui n'a pas le contrôle de ces liens.
...
La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux du ressort de la Cour d'appel de la ville de Nantes sont compétents.
</p>
<p>
ARTICLE 12 : Publication par l’Utilisateur
Le site permet aux membres de publier des œuvres personnelles.
